...
If you already have the data for your query synchronously available, you don't need to prefetch it. You can just use the [Query Client's `queryClient.setQueryData` method](https://tanstack.com/query/v5/docs/reference/QueryClient.md) to directly add or update a query's cached result by key.
