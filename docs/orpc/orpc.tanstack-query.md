---
url: https://orpc.dev/docs/integrations/tanstack-query.md
...
Before you begin, ensure you have already configured a [server-side client](orpc.server-side.md) or a [client-side client](orpc.client-side.md).
