---
url: https://orpc.dev/docs/client/server-side.md
description: >-
...
Call your [procedures](orpc.procedure.md) in the same environment as your server, no proxies required like native functions.

## Calling Procedures

oRPC offers multiple methods to invoke a [procedure](https://orpc.dev/docs/procedure.md).
...
Create a [router](https://orpc.dev/docs/router.md) based client to access multiple procedures:
