...
<FeedbackBlock id="e2a6c85477e024aa" body="Fumadocs has different parts:">
...
<FeedbackBlock id="725700dbda867115" body="Markdown/MDX: Markdown is a markup language for creating formatted text. Fumadocs natively supports Markdown and MDX (superset of Markdown).">
...
<FeedbackBlock id="c60d679f1e312845" body="Bun: A JavaScript runtime, we use it for running scripts.">
  **[Bun](https://bun.sh):** A JavaScript runtime, we use it for running scripts.
</FeedbackBlock>

<FeedbackBlock id="64125cfec9289987" body="Some basic knowledge of React.js would be useful for further customisations.">
  Some basic knowledge of React.js would be useful for further customisations.
</FeedbackBlock>

Automatic Installation [#automatic-installation]

<FeedbackBlock id="0369d25e54cba52e" body="A minimum version of Node.js 22 required.">
...
<FeedbackBlock id="f7d1b73a1d517bd4" body="It will ask you the built-in template to use:">
  It will ask you the built-in template to use:
</FeedbackBlock>

<FeedbackBlock id="c9218a3240875c89" body="React.js framework: Next.js, Waku, React Router, Tanstack Start.Content source: Fumadocs MDX.">
  * **React.js framework**: Next.js, Waku, React Router, Tanstack Start.
  * **Content source**: Fumadocs MDX.
</FeedbackBlock>

<FeedbackBlock id="998344b5b33a3574" body="A new fumadocs app should be initialized. Now you can start hacking!">
...
<FeedbackBlock id="a5f99088c987359e" body="Create your first MDX file in the docs folder.">
...
<FeedbackBlock id="53f523dbdc7e1213" body="Run the app in development mode and see http://localhost:3000/docs.">
...
<FeedbackBlock id="6356d46515789a9e" body="Some common questions you may encounter.">
...
<FeedbackBlock id="da72f23da565be9d" body="New to here? Don't worry, we are welcome for your questions.">
  New to here? Don't worry, we are welcome for your questions.
</FeedbackBlock>

<FeedbackBlock id="e40d35b3284f2c34" body="If you find anything confusing, please give your feedback on Github Discussion!">
...
<FeedbackBlock id="5874cd767894da99" body="For authoring docs, make sure to read:">
